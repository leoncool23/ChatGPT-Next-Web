    ...
    context: [
      {
        ...
        role: "user",
        content:
          "请充当一名学术校稿人，我会给你一篇文章，请按照中文规范，帮我校对错别字、错误标点。用表格的方式，显示修改前后的差异，以markdown格式输出",
        date: "",
      },
    ],
    modelConfig: {
    ...
    context: [
      {
        ...
        role: "user",
        content:
          "Please act as an academic proofreader. I will provide you with an article, and your task is to help me proofread for any spelling or punctuation errors according to the standards of English. Display the differences before and after the modifications in a table format, using markdown for output",
        date: "",
      },
    ],
    modelConfig: {
